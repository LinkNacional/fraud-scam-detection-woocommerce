...
class LknFsdwFraudAndScamDetectionForWoocommerceSettingsPage extends \WC_Settings_Page
{
    ...
    public function get_settings()
    {
        $settings = array(
            'section_title' => array(
                'title' => __('Antifraud Settings', 'fraud-and-scam-detection-for-woocommerce'),
                'type'  => 'title',
                'id'    => 'lkn_anti_fraud_section_title',
                'description' => '',
                'default' => '',
                'desc_tip' => false,
                'block_title' => __('Antifraud Settings', 'fraud-and-scam-detection-for-woocommerce'),
                'block_sub_title' => __('General antifraud protection settings.', 'fraud-and-scam-detection-for-woocommerce'),
                'input_description' => '',
            ),
            'enable_recaptcha' => array(
                'title'    => __('Enable reCAPTCHA', 'fraud-and-scam-detection-for-woocommerce'),
                'type'     => 'checkbox',
                'id'       => 'lknFraudDetectionForWoocommerceEnableRecaptcha',
                'default'  => 'no',
                'description' => __('Enable to activate reCAPTCHA during checkout.', 'fraud-and-scam-detection-for-woocommerce'),
                'desc_tip' => true,
                'block_title' => __('Enable reCAPTCHA', 'fraud-and-scam-detection-for-woocommerce'),
                'block_sub_title' => __('Protect checkout with reCAPTCHA.', 'fraud-and-scam-detection-for-woocommerce'),
                'input_description' => __('Enable to require reCAPTCHA validation at checkout.', 'fraud-and-scam-detection-for-woocommerce'),
                'custom_attributes' => array(),
            ),
            'recaptcha_selected' => array(
                'title'    => __('reCAPTCHA Version', 'fraud-and-scam-detection-for-woocommerce'),
                'type'     => 'select',
                ...
                'description' => __('Select the reCAPTCHA version to use at checkout.', 'fraud-and-scam-detection-for-woocommerce'),
                'desc_tip' => true,
                'block_title' => __('reCAPTCHA Version', 'fraud-and-scam-detection-for-woocommerce'),
                'block_sub_title' => __('Choose the reCAPTCHA version to use.', 'fraud-and-scam-detection-for-woocommerce'),
                'input_description' => __('Select the reCAPTCHA version for validation.', 'fraud-and-scam-detection-for-woocommerce'),
                'custom_attributes' => array(),
            ),
